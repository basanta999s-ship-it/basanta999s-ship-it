...
analyst = {
    ...
    "focus_areas": [
        ...
        "Power BI and Excel dashboard reporting",
        "Data cleaning and ETL preparation",
        "KPI definition and stakeholder reporting",
        "Data quality assurance and defect analysis",
    ],
    "what_i_bring": "A QA habit of checking the data before trusting it",
    "languages": ["English", "Hindi", "Nepali"],
    "open_to": "Data Analyst · Reporting Analyst · BI Analyst · Data QA",
    "work_authorization": "Permanent Resident — no sponsorship required",
}
```
...
![Power Query](https://img.shields.io/badge/Power_Query-F2C811?style=for-the-badge&logoColor=black)
...
|-----------|--------|-----------|
| Junior Data Analyst Program | NPower Canada | Jun 2026 – Sept 2026 |
| IBM Data Analyst Professional Certificate | IBM / Coursera | 2026 |
| ISTQB Certified Tester, Foundation Level (CTFL) | iSQI | Jun 2026 |
| Microsoft Azure AI Fundamentals (AI-900) | Microsoft | 2026 |
| DevOps: Beginners to Advanced with Projects | Udemy | May 2025 |
...
That's the background I bring to analytics — not just producing a number, but knowing what could make it wrong.
